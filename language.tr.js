module.exports = {
    ...
    help: [
        `*Emre Cebeci Bot*`,
        `Yardım Sayfası\n`,
        `*1-* _%ssticker_ : Atılan/alıntılanan resmi/videoyu/gifi stickere çevirir. `,
        `*2-* _%sban @kullanıcı_ : Etiketlenen kişiyi gruptan atar. (Kullanan kişinin ve benim yetkim olması gerek)`,
        `*3-* _%sanime_ : Anime kızı gönderir... (detaylı bilgi için: yardım anime)`,
        `*4-* _%shava <şehir>_ : Şehrin hava durumu bilgisini döndürür.`,
        `*5-* _%slink <YT linki>_ : YouTube videosunu sese çevirir.`,
        `*6-* _%syetki <belirle/çek> @etiket <belirle: seviye>_ : Kullanıcıya yetki verir.`,
        `*7-* _%sgüvenli <ekle/sil>_ : Grubu güvenli lsiteye ekler/siler.`,
    ...
    permissions_successfull: "Kullanıcının yetkisi %s olarak güncellendi.",
